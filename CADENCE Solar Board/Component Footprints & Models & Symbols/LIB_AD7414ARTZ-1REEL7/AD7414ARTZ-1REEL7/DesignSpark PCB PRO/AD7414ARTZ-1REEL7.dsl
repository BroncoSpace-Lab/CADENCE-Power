...
(library Library_1
	...
	(compDef "AD7414ARTZ-1REEL7" (originalName "AD7414ARTZ-1REEL7") (compHeader (numPins 6) (numParts 1) (refDesPrefix IC)
		...
		(compPin "1" (pinName "AS") (partNum 1) (symPinNum 1) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		...
		(compPin "6" (pinName "SDA") (partNum 1) (symPinNum 4) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		(compPin "5" (pinName "ALERT") (partNum 1) (symPinNum 5) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		(compPin "4" (pinName "SCL") (partNum 1) (symPinNum 6) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		...
		(attr "Datasheet Link" "https://www.analog.com/media/en/technical-documentation/data-sheets/AD7414_7415.pdf")
		(attr "Height" "1.45 mm")
	)
